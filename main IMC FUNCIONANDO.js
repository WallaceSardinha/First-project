...
form.onsubmit = function (event) {
    ...
    */
    ...
    var messageInfo = `Você tem ${weight}kg e ${height}cm de altura.`;
    var messageInfo2 = `Você vai se lascar, seu gordo de merda. ${weight}kg e ${height}cm de altura.`;
    ...
    switch (buttonM.checked) {
        ...
        case A1: {
            if (buttonM.checked) {
            document.querySelector('.modal-wrapper .h4 span').innerText = messageInfo;
            RG.innerText = message0;
            RG.style.color = "#e51f1f";
            info.innerText = `A magreza grave (IMC abaixo de 16) é uma condição que pode ser causada por desnutrição severa. Assim, consulte um médico, pois este peso é uma ameaça à saúde.`;
        }} break;
